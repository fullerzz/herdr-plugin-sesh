...
func (f *FakeClient) WorkspaceList(context.Context) ([]Workspace, error) {
	return f.Workspaces, f.WorkspaceListErr
}
...
func (f *FakeClient) TabList(context.Context, string) ([]Tab, error) { return f.Tabs, f.TabListErr }
...
func (f *FakeClient) PaneList(context.Context, string) ([]Pane, error) { return f.Panes, f.PaneListErr }
